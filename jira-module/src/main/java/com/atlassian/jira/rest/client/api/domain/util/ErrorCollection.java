...
public class ErrorCollection {
	...
	public ErrorCollection(@Nullable final Integer status, final Collection<String> errorMessages,
	...
	public boolean equals(final Object obj) {
		if (obj instanceof ErrorCollection) {
			...
			return Objects.equal(this.status, that.status) && Objects.equal(this.errors, that.errors)
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("status", status).add("errors", errors)
				.add("errorMessages", errorMessages).toString();
	}
	...
	public static class Builder {
		...
		public ErrorCollection build() {
			return new ErrorCollection(Integer.valueOf(status), errorMessages.build(), errors.build());
		}
	}
}
