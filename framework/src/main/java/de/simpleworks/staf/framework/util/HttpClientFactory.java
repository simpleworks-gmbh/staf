...
public class HttpClientFactory {
	...
	public static HttpClient createHttpClient() throws RuntimeException{
		...
		try {
			clazz =  Class.forName(System.getProperty(HTTP_CLIENT_CLASS, "de.simpleworks.staf.framework.api.httpclient.HttpClient"));	
		}
		catch(Exception ex) {
			final String msg = String.format("can't access class '%s'.", System.getProperty(HTTP_CLIENT_CLASS, "de.simpleworks.staf.framework.api.httpclient.HttpClient"));
			logger.error(msg,ex);
